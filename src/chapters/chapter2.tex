...
DevOps is a set of practices, techniques, and methodologies designed to accelerate
the Software Development Lifecycle (SDLC) by bridging the gap between software
development and IT operations. Development focuses on writing and improving the
software, while operations handle the provisioning, configuration, and maintenance
of the infrastructure that runs the applications.

In the context of our internship, DevOps practices are essential for migrating the
company’s monolithic system from a single virtual machine to a scalable cloud-based
infrastructure. By applying DevOps principles, we aim to automate deployment,
monitoring, and maintenance processes, ensuring that the application can scale
efficiently as the number of users increases.

Key concepts in DevOps include Continuous Integration (CI), Continuous Delivery (CD),
Infrastructure as Code (IaC), and automation of repetitive tasks. Leveraging these
principles allows development and operations teams to work collaboratively, reduce
errors, and deliver software updates reliably and continuously, which is crucial for
supporting a growing customer base and improving overall service quality.
